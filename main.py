...
#Configuración de pines para filas de luces y comunicación SPI con el controlador de luces
...
#Definición de código Morse como diccionario para traducción entre caracteres y código Morse
MORSE_CODE = {
    '.-': 'A', '-...': 'B', '-.-.': 'C', '-..': 'D', '.': 'E',
    '..-.': 'F', '--.': 'G', '....': 'H', '..': 'I', '.---': 'J',
    '-.-': 'K', '.-..': 'L', '--': 'M', '-.': 'N', '---': 'O',
...
#Mapa de caracteres a coordenadas de luces (fila y columna) para el controlador de luces
LIGHT_MAP = {
...
#Velocidad de puntos en código Morse (en segundos)
